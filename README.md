...
Key specs:
- [docs/symbol_map.md](docs/symbol_map.md) (human map)
- [symbol_map.shared.json](symbol_map.shared.json) (🧬 canonical meeting place)
- [docs/mcp_servers.md](docs/mcp_servers.md) (MCP capability boundary standard)

Demos (beta):
- [docs/demos/precog_demo.md](docs/demos/precog_demo.md)
- [docs/demos/scope_privacy_demo.md](docs/demos/scope_privacy_demo.md)
- [docs/demos/metaemotion_demo.md](docs/demos/metaemotion_demo.md)

Notes:
- Repo is docs-first; the canonical entrypoint is [docs/index.md](docs/index.md).
- License: GPL v3.
