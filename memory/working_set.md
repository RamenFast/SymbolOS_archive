...
- Do not store secrets (keys/tokens/seed phrases) in this repo.
...
- Notes: First session using file-backed memory; tasks summarised in session log `MRC-20260128-0249-01`.
