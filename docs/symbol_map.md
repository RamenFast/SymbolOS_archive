...
- `🧾` Ledger / audit trail
- `🛡️` Safety / permissions / boundaries
- `🔒` Privacy / sensitive scope
- `🧩` Schema / structured shape
- `🎲` DND mode (table-safe output)
- `🧬` Meeting place (return loop to `symbol_map.shared.json` + the active work surface)
