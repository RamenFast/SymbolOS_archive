...
- Character sheet integration (external): [dnd_character_sheet_integration.md](dnd_character_sheet_integration.md)
- Metaemotion (external): [metaemotion.md](metaemotion.md)
- Memory (external): [memory.md](memory.md)

## Schemas
- Schema index: [schemas.md](schemas.md)

## Meta-awareness
- Barriers and self-checks (external): [meta_awareness.md](meta_awareness.md)
